...
<body>
    ...
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-ajouter-categorie">
        Launch demo modal
    </button>
                ...
                <div class="modal-body">
                    <form action="">
                        <div class="form-group">
                            ...
                            <input name="nom-categorie" type="email" class="form-control" id="nom-categorie" placeholder="Nom de la catégorie">
                        </div>
